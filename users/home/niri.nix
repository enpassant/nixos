...
in {
    home.file.".config/niri/config.kdl".text = ''
        ...
        input {
            keyboard {
                xkb {
                    ...
                    // options "grp:win_space_toggle,compose:sclk"
        ...
        binds {
            ...
            XF86AudioStop allow-when-locked=true { spawn-sh "mpc stop"; }
            XF86Tools allow-when-locked=true { spawn-sh "foot -- ncmpcpp"; }
            XF86Calculator allow-when-locked=true { spawn-sh "gnome-calculator"; }
            XF86Search allow-when-locked=true { spawn-sh "foot -- lf ~"; }
            XF86Explorer allow-when-locked=true { spawn-sh "brave"; }
